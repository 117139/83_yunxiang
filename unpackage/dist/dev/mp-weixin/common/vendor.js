...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"yunxiang","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 11:
/*!***************************************************!*\
  !*** E:/phpStudy/WWW/83_yunxiang/common/event.js ***!
  \***************************************************/
/*! no static exports found */
...
/***/ 12:
/*!*****************************************************!*\
  !*** E:/phpStudy/WWW/83_yunxiang/common/amap-wx.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 16:
/*!*****************************************************!*\
  !*** E:/phpStudy/WWW/83_yunxiang/components/url.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _index = _interopRequireDefault(__webpack_require__(/*! ../store/index.js */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //马东元
var IPurl = '';var img_url = 'http://yunxiangziran.com.a.800123456.vip/';var denrg; // 图片拼接路径
var getimg = function getimg(imgs) {
  if (!imgs) {
    return;
  }
  if (imgs.indexOf('://') == -1) {
...
var wxlogin = function wxlogin(deng) {
  // 单个请求
  // console.log(deng)
  wx.login({
    success: function success(arr) {
      ...
      if (arr.code) {
        ...
        P_post('Member.Member/login', data).then(function (res) {
          console.log(res);
          if (res.status == 200) {
            uni.setStorage({
              key: 'token',
            ...
            var rescode = uni.getStorageSync('rescode');
            console.log(rescode);
            var datas = {
              code: rescode };

            P_get('Member.Member/getWechatOpenid', datas).then(function (nus) {
...
var wxlogins = function wxlogins(deng) {
  // 单个请求
  // console.log(deng)
  wx.login({
    success: function success(arr) {
      ...
      if (arr.code) {
        var met = uni.getStorageSync('met');
        var yan = uni.getStorageSync('yan');
        ...
        P_post('Member.Member/smsLogin', data).then(function (res) {
          console.log(res);
          if (res.status == 200) {
...
{var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$url = _ref.url,url = _ref$url === void 0 ? '' : _ref$url,_ref$param = _ref.param,param = _ref$param === void 0 ? {} : _ref$param,_ref$method = _ref.method,method = _ref$method === void 0 ? '' : _ref$method,_ref$header = _ref.header,header = _ref$header === void 0 ? { 'content-type': 'application/x-www-form-urlencoded', 'Authorization': uni.getStorageSync('token') || '' // 'userId':uni.getStorageSync('userId')||''
  } : _ref$header;
...
var tiaozhuan = function tiaozhuan(ee) {
  // console.log(ee, 'aaaa')
...
// 合作洽谈
var callphone = function callphone(e, datau) {
  // console.log(e)
  ...
  uni.makePhoneCall({
    ...
    success: function success(res) {
      ...
      P_post('Article.ArticleNeed/touch', datau).then(function (res) {
        // console.log(res) 
        if (res.status == 200) {
        } else {
          if (!res.msg) {
...
var getDate = function getDate(date) {
  ...
  var oldDate = new Date(Date.parse(date.replace(/-/g, "/")));
  var diff = parseInt(Math.abs(nowDate.getTime() - oldDate.getTime()) / 1000 / 60 / 60 / 24);
  return diff;
};var _default =
{
...
/***/ 8:
/*!**********************************************!*\
  !*** E:/phpStudy/WWW/83_yunxiang/service.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var imgurl = "https://yunxiangziran.com.a.800123456.vip/";
...
var jump = function jump(e) {
  ...
  if (datas.type == 'web') {
    ...
    _index.default.commit('web_url', datas.url);
    uni.navigateTo({
...
{var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$url = _ref.url,url = _ref$url === void 0 ? '' : _ref$url,_ref$param = _ref.param,param = _ref$param === void 0 ? {} : _ref$param,_ref$method = _ref.method,method = _ref$method === void 0 ? '' : _ref$method,_ref$header = _ref.header,header = _ref$header === void 0 ? { 'content-type': 'application/x-www-form-urlencoded', 'token': uni.getStorageSync('token') || '' } : _ref$header;
  console.log(header);
  var timeStart = Date.now();
  return new Promise(function (resolve, reject) {
    console.log('请求url：' + getUrl(url));
...
//   console.log(e)
// })
var getimg = function getimg(img, type) {
  // return img
...
var gettime = function gettime(mj, join_msg) {
  if (!mj) {
    return {};
  }
  if (!join_msg) {
...
/***/ 9:
/*!**************************************************!*\
  !*** E:/phpStudy/WWW/83_yunxiang/store/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    setadd: function setadd(state, addmsg) {
      state.addmsg = addmsg;
